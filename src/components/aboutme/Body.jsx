  ...
  return (
    <div className="Aboutme__Accordions">
      ...
      <Accordion title="Programming">
        SOLID principles, DRY, KISS, YAGNI, Clean Code at all costs. <br />{" "}
        Constant Refactoring, trying to comment my code as good as I can. <br />
      ...
      <Accordion title="Frontend">
        ...
        effect. SCSS for styling. Trying to do my best when it comes to RWD.
      </Accordion>
      ...
      <Accordion title="Actual techstack">
        JavaScript have started to by my second name during the last year.
        Changing my previous php-based approach to JS was a game changer. <br />
      ...
      <Accordion title="2k21 Todo's">
        ...
        Place emphasis on application testing and approach before even writing
